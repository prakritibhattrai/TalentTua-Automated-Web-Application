...
//    <div className="bg-white border border-gray-200 rounded-lg p-6 space-y-3 dark:bg-neutral-900 dark:border-neutral-700">
...
//            {education || "No results found"}
//            <br />
//            <span className="text-xs text-gray-600">
//              {educationDescription || "No description found"}{" "}
//            </span>
//          </li>
//        </ul>
//      </div>
...
//        </h3>
//      </div>
//      <ul className="mt-3  list-disc list-outside space-y-1.5 ps-3.5">
//        {interests && interests.length > 0 ? (
//          interests.map((trait, index) => (
//            <li
//              key={index}
//              className="text-sm text-gray-800 dark:text-neutral-200 space-y-1.5"
//            >
//              {trait.name || []}
//            </li>
//          ))
...
//            href="mailto:recruiter5@gmail.com"
//          >
//            <svg
//              xmlns="http://www.w3.org/2000/svg"
