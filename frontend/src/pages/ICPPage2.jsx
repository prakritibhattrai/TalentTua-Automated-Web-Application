              ...
              <div className="sm:-ms-4 py-6 sm:px-4">
                ...
                <blockquote>
                  <span className="text-sm text-gray-800 dark:text-neutral-200">
                    I absolutely floored by the level of care and attention to
              ...
              <div className="group relative flex gap-x-5">
                ...
                <div className="grow pb-8 group-last:pb-0">
                  ...
                  <p className="mt-1 text-sm text-gray-600 dark:text-neutral-400">
                    ...
                    employees. It becoming a big company but it still private,
                    so the culture is as good as it gets at 1,000+ employees if
                    you ask me. Managers are still adapting to the growth I
                        ...
                        <div className="grow p-4 ms-32 sm:ms-48">
                          <div className="min-h-24 flex flex-col justify-center">
                            ...
                            <p className="mt-1 text-sm text-gray-500 dark:text-neutral-500">
                              ...
                              leveraging Mailchimp innovative broadcast studio.
                            </p>
                          </div>
                        </div>
                      </div>
