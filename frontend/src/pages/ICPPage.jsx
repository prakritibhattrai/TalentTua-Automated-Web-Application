        ...
        <ul className="mt-8 space-y-5">
          ...
          <li className="max-w-4xl py-2 px-4 sm:px-6 lg:px-8 mx-auto flex gap-x-2 sm:gap-x-4">
            <div className="grow max-w-[90%] md:max-w-2xl w-full space-y-3">
              {/* Card */}
              <h2 className="font-medium text-gray-800 dark:text-white">
                Desired soft skills on basis of trait matrix for the role
              </h2>
              {/* End Card */}
              {/* Timeline */}
              <div>
                ...
                <div className="group relative flex gap-x-5">
                  ...
                  <div className="grow pb-8 group-last:pb-0">
                    ...
                    <p className="mt-1 text-sm text-gray-600 dark:text-neutral-400">
                      ...
                      so the culture is as good as it gets at 1,000+ employees
                      if you ask me. Managers are still adapting to the growth I
                          ...
                          <div className="grow p-4 ms-32 sm:ms-48">
                            <div className="min-h-24 flex flex-col justify-center">
                              ...
                              <p className="mt-1 text-sm text-gray-500 dark:text-neutral-500">
                                ...
                                leveraging Mailchimp innovative broadcast
                                studio.
                              </p>
                            </div>
                          </div>
